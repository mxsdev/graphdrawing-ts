...
"node sep": {
  ...
  type: "length",
  use: [
    { key: "node pre sep", value: (v: number) => v/2 },
    { key: "node post sep", value: (v: number) => v/2 },
  ],
  summary: `"
...
"layer distance": {
  ...
  type: "length",
  use: [
    { key: "level distance", value: (v: any) => v },
  ],
...
"layer pre sep": {
  ...
  type: "length",
  use: [
    { key: "level pre sep", value: (v: any) => v },
  ],
...
"layer post sep": {
  ...
  type: "length",
  use: [
    { key: "level post sep", value: (v: any) => v },
...
"level sep": {
  ...
  type: "length",
  use: [ 
    { key: "level pre sep", value: (v: number) => v/2 },
    { key: "level post sep", value: (v: number) => v/2 },
...
"sibling sep": {
  ...
  type: "length",
  use: [  
    { key: "sibling pre sep", value: (v: number) => v/2 },
    { key: "sibling post sep", value: (v: number) => v/2 },
...
"part sep": {
  ...
  type: "length",
  use: [  
    { key: "part pre sep", value: (v: number) => v/2 },
    { key: "part post sep", value: (v: number) => v/2 },
